    ...
    return (
        <>
            <div className="max-w-2xl mx-auto p-4">
                ...
                <h3 className="text-lg font-bold mt-4 mb-2">Domestic Shipping Rates and Estimates</h3>
                <p>For calculated shipping rates: Shipping charges for your order will be calculated and displayed at checkout.</p>
                <p>Free local delivery is available for orders over £25 within the UK. Deliveries are made from 9:00am on Monday to Friday. We will contact you via text message with the phone number you provided at checkout to notify you on the day of our arrival.</p>
                
                <h3 className="text-lg font-bold mt-4 mb-2">International Shipping</h3>
